...
import '../nfc/nfc_service_lab1.dart';
...
class _Lab1ScreenState extends State<Lab1Screen> {
  final NfcServiceLab1 _nfcService = NfcServiceLab1();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Lab 1 - The Bad Way'),
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'This lab executes the NFC flow completely in Dart. Each sector detect, login, read, and write sends an individual MethodChannel call to the Native Android layer.',
                textAlign: TextAlign.center,
                style: TextStyle(fontSize: 16),
              ),
              const SizedBox(height: 32),
              ElevatedButton(
                onPressed: _isRunning ? null : _runLab1,
                ...
                child: _isRunning
                    ...
                    : const Text('Start Lab 1', style: TextStyle(fontSize: 18)),
              ),
              const SizedBox(height: 32),
              Container(
